...
object CoolLogtest {
  ...
  def main(args: Array[String]){
    ...
    val conf = new SparkConf().setAppName("CoolLogtest")
    ...
    val url1 = "http://hklpathas02.hk.standardchartered.com:8088/ws/v1/cluster/apps" + "?user=" + userName + "&startedTimeBegin=" + startTime 
    println("***********************PRINTING URL1 *****************")
    println(url1)
    
    val url2 = "http://hklpathas01.hk.standardchartered.com:8088/ws/v1/cluster/apps" + "?user=" + userName + "&startedTimeBegin=" + startTime 
    ...
    df2Final.coalesce(1).write.mode("append").partitionBy("ods").format("hive").saveAsTable("t3_ocir_open.cool_yarn_logs")
